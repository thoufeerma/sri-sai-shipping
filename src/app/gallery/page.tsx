...
export default function GalleryPage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--color-bg-main)]">
      ...
      <section className="pb-32 bg-[var(--color-bg-main)] relative z-10 theme-section">
        <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 md:px-8 pt-8 md:pt-16">
          {images.length > 0 ? (
            <GalleryGrid images={images} />
          ) : (
            <div className="text-center py-20 theme-text bg-[var(--color-bg-main)]/50 rounded-2xl border border-white/10 shadow-sm theme-card">
