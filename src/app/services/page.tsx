...
const services = [
  ...
  },
  {
    ...
    image: "/services/coastal-services.webp",
  },
  {
    ...
    <div ref={containerRef} className="min-h-screen pb-32">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 mt-24 space-y-8">
        {services.map((service, idx) => (
          <div key={idx} className="service-card group grid grid-cols-1 md:grid-cols-2 gap-0 rounded-3xl overflow-hidden border border-white/10 theme-card hover:theme-card-hover hover:border-[var(--color-accent-cyan)]/30 hover:shadow-[0_15px_40px_rgba(0,113,156,0.2)] hover:-translate-y-1 transition-all duration-500">
            ...
            {/* Content */}
            <div className="bg-[var(--color-bg-alt)]/60 p-10 md:p-12 flex flex-col justify-center backdrop-blur-sm">
              ...
              <p className="theme-text leading-relaxed font-light">{service.desc}</p>
            </div>
          </div>
        ))}
      </div>
