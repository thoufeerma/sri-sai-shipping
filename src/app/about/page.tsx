    ...
    <div ref={containerRef} className="min-h-screen pb-32">
      ...
      <section className="py-24 theme-section">
        <div className="max-w-4xl mx-auto px-6 md:px-12">
          <p className="fade-up text-xs theme-text tracking-widest uppercase mb-4">OUR HISTORICAL TIMELINE</p>
          <h2 className="fade-up text-3xl md:text-5xl font-medium theme-heading tracking-tight mb-6 leading-tight">
            Rooted in Tradition, Delivering Worldwide
          </h2>
          <p className="fade-up text-xl md:text-2xl theme-text leading-relaxed font-light">
      ...
      {/* ─── MISSION & VISION ─── */}
      <section className="py-12 border-t theme-border theme-section">
        <div className="max-w-4xl mx-auto px-6 md:px-12">
          <p className="fade-up text-xs theme-text tracking-widest uppercase mb-2">THE CORPORATE MANDATE</p>
          <h3 className="fade-up text-xl font-medium theme-heading mb-6">Guiding Our Path forward</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-8">
            <div className="fade-up">
              <h3 className="text-xs theme-text tracking-widest uppercase mb-4">THE MISSION</h3>
            ...
            <div className="fade-up">
              <h3 className="text-xs theme-text tracking-widest uppercase mb-4">THE VISION</h3>
              <p className="theme-text text-sm leading-relaxed">
      ...
      <section className="py-16 theme-section">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="fade-up relative h-[500px] rounded-3xl overflow-hidden shadow-[0_20px_50px_rgba(0,113,156,0.15)]">
            <Image src="/cargo-ship.webp" alt="Global cargo operations" fill className="object-cover opacity-80" />
          ...
          <div className="fade-up space-y-10">
            <div>
              <p className="theme-text text-xs tracking-widest uppercase mb-2">UNCOMPROMISING VALUES</p>
              <h2 className="text-3xl font-medium theme-heading mb-4">Core Cultural Pillars</h2>
            ...
            <div className="space-y-6">
              {[
                ...
                <div key={i} className="flex gap-4 items-start border-t theme-border pt-6">
                  <span className="text-[var(--color-accent-cyan)] font-light text-lg mt-0.5">0{i + 1}</span>
                  <div>
                    <h4 className="theme-heading font-medium mb-1">{v.title}</h4>
                    <p className="theme-text text-sm leading-relaxed">{v.desc}</p>
                  </div>
                </div>
              ))}
            </div>
      ...
      <section className="py-24 border-t theme-border theme-section">
        <div className="max-w-4xl mx-auto px-6 md:px-12">
          <h2 className="fade-up text-4xl font-medium theme-heading mb-20">The journey.</h2>
          <div className="space-y-16 border-l theme-border pl-8 ml-2">
            {[
              ...
              <div key={i} className="fade-up relative">
                ...
                <div className="flex flex-col md:flex-row gap-4 md:gap-12 md:items-baseline">
                  <div className="text-xl text-[var(--color-accent-cyan)] font-bold md:w-24 shrink-0">{item.year}</div>
                  <div>
                    <h3 className="text-xl font-medium theme-heading mb-2">{item.title}</h3>
