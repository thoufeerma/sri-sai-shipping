            ...
            <button
              ...
              className={`px-6 py-2.5 rounded-full text-sm font-medium transition-all duration-300 ${
                activeCategory === category
                  ? "bg-[var(--color-primary)] text-white shadow-[0_4px_14px_rgba(0,113,156,0.4)] border border-[var(--color-accent-cyan)]/30"
                  : "bg-[var(--color-bg-main)]/50 text-[var(--color-text-secondary)] hover:text-white hover:bg-[var(--color-bg-alt)] border border-white/10 shadow-sm backdrop-blur-md"
              }`}
            >
              {category}
            </button>
