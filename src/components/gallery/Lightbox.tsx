  ...
  return (
    <AnimatePresence>
      ...
      >
        {/* Cinematic Backdrop */}
        <div 
          className="absolute inset-0 bg-[var(--color-bg-main)]/95 backdrop-blur-2xl" 
          onClick={onClose} 
        />
        
        {/* Subtle Ambient Glow */}
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-[var(--color-primary)]/20 via-transparent to-transparent pointer-events-none" />
