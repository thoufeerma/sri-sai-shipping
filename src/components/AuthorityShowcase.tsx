  ...
  return (
    <div className="space-y-4">
      ...
      <motion.h2
        ...
        className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight theme-heading uppercase leading-[1.05]"
      >
        REDEFINING<br />
  ...
  return (
    <div className="flex -space-x-3 items-center">
      {[1, 2, 3, 4].map((i) => (
        <div
          key={i}
          className="w-8 h-8 rounded-full border border-white/20 bg-[var(--color-bg-main)] flex items-center justify-center text-[var(--color-accent-cyan)] ring-1 ring-white/10"
        >
      ...
      <div className="w-8 h-8 rounded-full border border-white/20 bg-[var(--color-primary)] flex items-center justify-center text-[10px] font-bold text-white ring-1 ring-white/10">
        +50
      </div>
    </div>
  );
...
export function CTARow() {
  return (
    ...
    >
      <Link
        href="/about"
        className="group inline-flex items-center gap-2 theme-heading hover:text-[var(--color-accent-cyan)] transition-colors text-sm font-semibold tracking-wider uppercase border-b border-white/20 pb-1 hover:border-[var(--color-accent-cyan)]"
      >
        Read Our Heritage
...
export function FloatingInfoCard() {
  return (
    <motion.div
      ...
      className="absolute bottom-4 left-4 right-4 md:bottom-6 md:left-6 md:right-6 flex items-center gap-4 bg-[var(--color-bg-main)]/90 backdrop-blur-md border border-white/10 p-4 rounded-xl shadow-[0_10px_40px_rgba(0,113,156,0.15)]"
    >
      <div className="bg-[var(--color-primary)] text-white flex items-center justify-center rounded-lg w-10 h-10 shrink-0 shadow-lg shadow-[var(--color-accent-cyan)]/20">
        <Anchor size={18} strokeWidth={2} />
      </div>
      <div className="text-left">
        <h4 className="theme-heading font-semibold text-sm">Tier-1 Port Access</h4>
        <p className="theme-text text-xs mt-0.5 leading-normal">
...
export default function AuthorityShowcase() {
  return (
    <section className="py-20 md:py-32 relative overflow-hidden theme-section border-b border-white/10">
      <div className="absolute top-0 right-0 w-[50%] h-[500px] bg-gradient-to-bl from-[var(--color-primary)]/10 via-transparent to-transparent pointer-events-none blur-3xl" />
      <AmbientGradient />
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 md:px-12 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center relative z-10">
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <motion.div
            ...
            className="border-l border-[var(--color-accent-cyan)]/30 pl-4"
          >
            <p className="theme-heading text-lg md:text-xl font-semibold leading-relaxed">
        ...
        <div className="lg:col-span-5 relative">
          <motion.div
            ...
            className="border border-white/10 p-3 rounded-[32px] bg-[var(--color-bg-main)]/80 backdrop-blur-md shadow-[0_20px_50px_rgba(0,113,156,0.15)] relative"
          >
