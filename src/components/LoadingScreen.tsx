...
function ShipSVG() {
  return (
    <svg width="64" height="22" viewBox="0 0 80 28" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M2 16 L8 11 L68 11 L77 16 L74 22 L5 22 Z" fill="rgba(255,255,255,0.88)" />
...
export default function LoadingScreen() {
  ...
  return (
    <div
      ...
      style={{ background: "radial-gradient(ellipse 90% 70% at 50% 50%, #0d1118 0%, #050609 100%)" }}
    >
      {/* Subtle ambient top glow */}
      <div className="absolute top-0 inset-x-0 h-48 bg-gradient-to-b from-blue-950/20 to-transparent pointer-events-none" />

      {/* Brand text — character-level mask reveal */}
      <div className="overflow-hidden mb-3">
        <div className="flex tracking-[0.32em] text-sm md:text-base font-light text-white/80">
      ...
      <div className="ls-sub text-[10px] tracking-[0.55em] text-white/28 uppercase mb-20">
      ...
      <div className="relative w-72 md:w-[420px]">
        ...
        <div
          ...
          style={{ background: "radial-gradient(circle, rgba(180,210,255,0.35), transparent 70%)", filter: "blur(8px)", pointerEvents: "none" }}
        />

        {/* Track */}
        <div
          ref={trackRef}
          className="ls-track h-[1px] bg-white/10 relative"
        ...
        >
          ...
          <div
            ...
            style={{ background: "linear-gradient(to right, rgba(255,255,255,0.3), rgba(255,255,255,0.7))" }}
          />
          ...
          >
            ...
            <div className="absolute top-[14px] right-full flex flex-col gap-[3px] pr-1 opacity-25">
              {[32, 22, 12].map((w, i) => (
                <div key={i} className="h-[0.5px] bg-white/60 rounded-full" style={{ width: w, marginLeft: (32 - w) * 0.3 }} />
              ))}
            </div>
            {/* Gentle bob */}
      ...
      {/* Status */}
      <div className="ls-status mt-14 text-[10px] tracking-[0.5em] text-white/20 uppercase">
