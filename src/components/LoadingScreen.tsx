...
function ShipSVG() {
  return (
    <svg width="64" height="22" viewBox="0 0 80 28" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M2 16 L8 11 L68 11 L77 16 L74 22 L5 22 Z" fill="rgba(255,255,255,0.85)" />
      <rect x="18" y="6" width="8" height="5" rx="0.5" fill="rgba(255,255,255,0.48)" />
      <rect x="28" y="6" width="8" height="5" rx="0.5" fill="rgba(255,255,255,0.36)" />
      <rect x="38" y="6" width="8" height="5" rx="0.5" fill="rgba(255,255,255,0.44)" />
      <rect x="48" y="6" width="8" height="5" rx="0.5" fill="rgba(255,255,255,0.36)" />
      <rect x="58" y="6" width="8" height="5" rx="0.5" fill="rgba(255,255,255,0.44)" />
      <rect x="6" y="3" width="13" height="8" rx="1" fill="rgba(255,255,255,0.76)" />
      <rect x="8" y="1" width="9" height="4" rx="0.5" fill="rgba(255,255,255,0.6)" />
      <line x1="13" y1="1" x2="13" y2="-1" stroke="rgba(255,255,255,0.4)" strokeWidth="0.8" />
      <line x1="13" y1="-1" x2="20" y2="-1" stroke="rgba(255,255,255,0.3)" strokeWidth="0.6" />
      <circle cx="30" cy="17" r="1.2" fill="rgba(255,255,255,0.18)" />
      <circle cx="46" cy="17" r="1.2" fill="rgba(255,255,255,0.18)" />
      <circle cx="62" cy="17" r="1.2" fill="rgba(255,255,255,0.18)" />
    </svg>
  );
}
...
export default function LoadingScreen() {
  ...
  return (
    <div
      ...
      style={{ background: "radial-gradient(ellipse 90% 70% at 50% 50%, var(--color-bg-alt) 0%, var(--color-bg-main) 100%)" }}
    >
      {/* Subtle ambient top glow */}
      <div className="absolute top-0 inset-x-0 h-48 bg-gradient-to-b from-[var(--color-primary)]/30 to-transparent pointer-events-none" />

      {/* Brand text — character-level mask reveal */}
      <div className="overflow-hidden mb-3">
        <div className="flex tracking-[0.32em] text-sm md:text-base font-light text-white">
      ...
      <div className="ls-sub text-[10px] tracking-[0.55em] text-[var(--color-text-secondary)] uppercase mb-20">
      ...
      <div className="relative w-72 md:w-[420px]">
        ...
        <div
          ...
          style={{ background: "radial-gradient(circle, var(--color-accent-cyan), transparent 70%)", filter: "blur(8px)", pointerEvents: "none", opacity: 0.6 }}
        />

        {/* Track */}
        <div
          ref={trackRef}
          className="ls-track h-[1px] bg-white/20 relative"
        ...
        >
          ...
          <div
            ...
            style={{ background: "linear-gradient(to right, rgba(34,211,238,0.2), var(--color-accent-cyan))" }}
          />
          ...
          >
            ...
            <div className="absolute top-[14px] right-full flex flex-col gap-[3px] pr-1 opacity-25">
              {[32, 22, 12].map((w, i) => (
                <div key={i} className="h-[0.5px] bg-cyan-400/60 rounded-full" style={{ width: w, marginLeft: (32 - w) * 0.3 }} />
              ))}
            </div>
            {/* Gentle bob */}
      ...
      {/* Status */}
      <div className="ls-status mt-14 text-[10px] tracking-[0.5em] text-[var(--color-text-secondary)] uppercase">
